  ...
  getCaseGraph: async (caseId = 'CR-204', filters = {}) => {
    try {
      ...
      const allFallbackNodes = [
        // 1. PERSONS (Suspects)
        { data: { id: 'PERSON-001', label: 'Viktor Voronin', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'CRITICAL', size: 52, details: 'Kingpin orchestrating ransomware networks, avionics smuggling, and offshore escrow laundering. Aliases: The Architect, Cypher-9.', case_id: caseId, lat: 40.7128, lng: -74.0060, city: 'New York / Geneva', country: 'United States / Switzerland', interpol: 'RED_NOTICE_A-4891' } },
        { data: { id: 'PERSON-002', label: 'Elena Rostov', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'HIGH', size: 48, details: 'Financial broker and darknet escrow operator facilitating port access and encrypted communications. Aliases: Valkyrie, CipherQueen.', case_id: caseId, lat: 47.3769, lng: 8.5417, city: 'Zurich Financial Hub', country: 'Switzerland', interpol: 'WARRANT_FIN_918' } },
        { data: { id: 'PERSON-003', label: 'Darius Vance', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'HIGH', size: 46, details: 'Armed logistics enforcer supervising warehouse arms distribution and decoy armored transports. Aliases: Ironclad, Heavy-D.', case_id: caseId, lat: 40.6892, lng: -74.0445, city: 'Port of NY/NJ', country: 'United States', interpol: 'ACTIVE_FEDERAL_WARRANT' } },
        { data: { id: 'PERSON-004', label: 'Marcus Kane', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'MEDIUM', size: 42, details: 'Signal interception and hardware tap specialist suspected of tampering with port CCTV relays. Aliases: Specter, Wiretapper.', case_id: caseId, lat: 51.2194, lng: 4.4025, city: 'Antwerp', country: 'Belgium', interpol: 'EUROPOL_MONITOR_77' } },
        { data: { id: 'PERSON-005', label: 'Viktor Chen (Cipher_Ghost)', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'CRITICAL', size: 50, details: 'Autonomous ransomware developer and zero-day broker linked to municipal utility breaches.', case_id: caseId, lat: 25.0330, lng: 121.5654, city: 'Taipei', country: 'Taiwan', interpol: 'RED_NOTICE_CYBER-09' } },
        { data: { id: 'PERSON-006', label: 'Marek Rostov', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'HIGH', size: 46, details: 'Tactical logistics chief managing high-speed armored transit convoys across harbor perimeter.', case_id: caseId, lat: 40.7589, lng: -73.9851, city: 'New York', country: 'United States' } },
        { data: { id: 'PERSON-007', label: 'Elena Thorne (Chameleon-9)', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'HIGH', size: 44, details: 'Synthetic media creator and 3D biometric credential counterfeiter for cross-border transit.', case_id: caseId, lat: 51.5074, lng: -0.1278, city: 'London', country: 'United Kingdom' } },
        { data: { id: 'PERSON-008', label: 'Tariq Al-Mansoor', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'CRITICAL', size: 48, details: 'Cryptocurrency wash ring operator managing cross-chain flash-loan liquidity pools.', case_id: caseId, lat: 25.2048, lng: 55.2708, city: 'Dubai DIFC', country: 'United Arab Emirates', interpol: 'FATF_WATCHLIST_AE' } },
        { data: { id: 'PERSON-009', label: 'Katya Orlova (Red Phantom)', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'HIGH', size: 44, details: 'SCADA telemetry manipulator and railway routing saboteur.', case_id: caseId, lat: 44.4268, lng: 26.1025, city: 'Bucharest', country: 'Romania' } },
        { data: { id: 'PERSON-010', label: 'Arturo Ruiz (El Silencio)', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'HIGH', size: 44, details: 'Maritime container smuggling dispatcher operating through Terminal C berths.', case_id: caseId, lat: 10.3997, lng: -75.5144, city: 'Cartagena', country: 'Colombia', interpol: 'INTERPOL_MARITIME_ALERT' } },
        { data: { id: 'PERSON-011', label: 'Jin Park (ZeroTrace)', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'MEDIUM', size: 42, details: 'Tor gateway node administrator and encrypted relay provider for Apex Cell.', case_id: caseId, lat: 37.5665, lng: 126.9780, city: 'Seoul', country: 'South Korea' } },
        { data: { id: 'PERSON-012', label: 'Isabella Cruz (Nemesis)', type: 'Person', shape: 'ellipse', color: '#9B3D45', threat: 'HIGH', size: 44, details: 'Electronic counter-surveillance officer responsible for RF jamming operations.', case_id: caseId, lat: 38.7223, lng: -9.1393, city: 'Lisbon', country: 'Portugal' } },

        // 2. PHONES & COMMS
        { data: { id: 'PHONE-001', label: 'RF 868MHz Jammer / Tap', type: 'Phone', shape: 'round-rectangle', color: '#5B7C99', threat: 'HIGH', size: 40, details: 'Encrypted frequency pulse beacon triangulated near Terminal C checkpoint.', case_id: caseId, lat: 40.7145, lng: -74.0045, city: 'New York', country: 'United States' } },
        { data: { id: 'PHONE-002', label: 'SatPhone +882-16-992', type: 'Phone', shape: 'round-rectangle', color: '#5B7C99', threat: 'HIGH', size: 40, details: 'Encrypted burner satellite link routed through Pier 4 repeater.', case_id: caseId, lat: 40.7061, lng: -74.0092, city: 'New York', country: 'United States' } },
        { data: { id: 'PHONE-003', label: 'Tor Gateway Node 185.220', type: 'Phone', shape: 'round-rectangle', color: '#5B7C99', threat: 'CRITICAL', size: 40, details: 'Primary ingress IP used to dispatch ransomware payloads.', case_id: caseId, lat: 64.1466, lng: -21.9426, city: 'Reykjavik Data Vault', country: 'Iceland' } },

        // 3. VEHICLES
        { data: { id: 'VEHICLE-001', label: 'Black Escalade (8B9-CYP)', type: 'Vehicle', shape: 'diamond', color: '#B58A45', threat: 'HIGH', size: 46, details: 'Observed departing Terminal C; registered to shell logistics entity.', case_id: caseId, lat: 40.7138, lng: -74.0048, city: 'New York', country: 'United States' } },
        { data: { id: 'VEHICLE-002', label: 'Armored Yukon (NY-889XQ)', type: 'Vehicle', shape: 'diamond', color: '#B58A45', threat: 'HIGH', size: 44, details: 'Reinforced SUV with covert radio installation and tinted thermal glass.', case_id: caseId, lat: 40.6722, lng: -74.0210, city: 'New York', country: 'United States' } },
        { data: { id: 'VEHICLE-003', label: 'Freight Switcher Unit 14-B', type: 'Vehicle', shape: 'diamond', color: '#B58A45', threat: 'CRITICAL', size: 44, details: 'Remotely diverted locomotive used to mask rail contraband transit.', case_id: caseId, lat: 40.7200, lng: -74.0300, city: 'New Jersey', country: 'United States' } },

        // 4. FINANCIAL ACCOUNTS
        { data: { id: 'FIN-001', label: 'Tether Wallet 0x889...F1C', type: 'Financial Account', shape: 'hexagon', color: '#4F7A67', threat: 'CRITICAL', size: 46, details: 'Cryptocurrency escrow address with 140K USDT transaction volume.', case_id: caseId, lat: 19.3133, lng: -81.2546, city: 'George Town', country: 'Cayman Islands' } },
        { data: { id: 'FIN-002', label: 'Darknet Mixer Node 36', type: 'Financial Account', shape: 'hexagon', color: '#4F7A67', threat: 'CRITICAL', size: 44, details: 'Decentralized liquidity tumbler splitting funds across micro-wallets.', case_id: caseId, lat: 51.9244, lng: 4.4777, city: 'Rotterdam Data Center', country: 'Netherlands' } },
        { data: { id: 'FIN-003', label: 'Crypto Wallet 0x8F9...41D', type: 'Financial Account', shape: 'hexagon', color: '#4F7A67', threat: 'HIGH', size: 44, details: 'Mixer deposit address with $4.2M monitored inflow.', case_id: caseId, lat: 25.2048, lng: 55.2708, city: 'Dubai Multi-Sig Vault', country: 'United Arab Emirates' } },

        // 5. LOCATIONS
        { data: { id: 'LOC-001', label: 'Terminal C Harbor Depot', type: 'Location', shape: 'octagon', color: '#3F5F78', threat: 'HIGH', size: 48, details: 'Sector 4 customs warehouse and avionics container staging site.', case_id: caseId, lat: 40.7145, lng: -74.0045, city: 'Port of NY/NJ', country: 'United States' } },
        { data: { id: 'LOC-002', label: 'Warehouse 14B Safehouse', type: 'Location', shape: 'octagon', color: '#3F5F78', threat: 'HIGH', size: 46, details: 'Tactical command center containing servers, repeaters, and forged passports.', case_id: caseId, lat: 40.7020, lng: -73.9710, city: 'Brooklyn Navy Yard', country: 'United States' } },
        { data: { id: 'LOC-003', label: 'Sector 2 Freight Exchange', type: 'Location', shape: 'octagon', color: '#3F5F78', threat: 'MEDIUM', size: 44, details: 'Industrial rail junction subject to SCADA telemetry spoofing.', case_id: caseId, lat: 40.7300, lng: -74.0500, city: 'Sector 2 Freight Exchange', country: 'United States' } },

        // 6. ORGANIZATIONS
        { data: { id: 'ORG-001', label: 'Apex Cyber Syndicate', type: 'Organization', shape: 'rectangle', color: '#8D98A5', threat: 'CRITICAL', size: 50, details: 'Transnational cybercrime network targeting municipal utility systems and defense logistics.', case_id: caseId, lat: 50.1109, lng: 8.6821, city: 'Frankfurt DE-CIX Hub', country: 'Germany' } },
        { data: { id: 'ORG-002', label: 'Kowloon Port Cartel', type: 'Organization', shape: 'rectangle', color: '#8D98A5', threat: 'HIGH', size: 46, details: 'Maritime container logistics and armed contraband escort cartel.', case_id: caseId, lat: 22.2871, lng: 114.1917, city: 'Victoria Harbour', country: 'Hong Kong SAR' } },
        { data: { id: 'ORG-003', label: 'GhostNet Logistics', type: 'Organization', shape: 'rectangle', color: '#8D98A5', threat: 'HIGH', size: 46, details: 'Shell forwarding firm providing fictitious bills of lading and escrow facilities.', case_id: caseId, lat: 8.9824, lng: -79.5199, city: 'Panama City / Colon', country: 'Panama' } },

        // 7. EVIDENCE
        { data: { id: 'EV-0182', label: 'Call_Record_Microwave_Tap.csv', type: 'Evidence', shape: 'tag', color: '#5B7C99', threat: 'EVIDENCE', size: 42, details: 'Decrypted intercept wiretap log corroborating suspect communications.', case_id: caseId, lat: 40.7145, lng: -74.0045, city: 'New York', country: 'United States' } },
        { data: { id: 'EV-0184', label: 'CCTV_Terminal_C_Frame_0418.jpg', type: 'Evidence', shape: 'tag', color: '#5B7C99', threat: 'EVIDENCE', size: 42, details: 'ArcFace biometric match frame from Gate 4 security camera.', case_id: caseId, lat: 40.7138, lng: -74.0048, city: 'New York', country: 'United States' } },
        { data: { id: 'EV-0185', label: 'Escrow_Wallet_Ledger_Dump.json', type: 'Evidence', shape: 'tag', color: '#5B7C99', threat: 'EVIDENCE', size: 42, details: 'On-chain transaction signatures linking suspects to illicit wash accounts.', case_id: caseId, lat: 19.3133, lng: -81.2546, city: 'Cayman Islands', country: 'Cayman Islands' } },
        { data: { id: 'EV-0189', label: 'ALPR_Toll_Exit14_Capture.png', type: 'Evidence', shape: 'tag', color: '#5B7C99', threat: 'EVIDENCE', size: 42, details: 'License plate optical recognition hit on northbound getaway convoy.', case_id: caseId, lat: 40.6800, lng: -74.1500, city: 'Exit 14 ALPR Toll', country: 'United States' } }
      ];
